...
require '../../config/classes/Notification.php';
Session::init();
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="card card-plain">
                      <?php $info =Notification::feeds();
                      foreach ($info as $value) { ?>

                      <div class="card-body">
                        <div class="alert alert-success alert-with-icon fade show" data-notify="container">
                          <span data-notify="icon" class="nc-icon nc-bell-55"></span>
                          <span data-notify="message">Date: <?php echo $value['notice_time'] ?> 
                          <br/><?php echo $value['message']?> <br/>
                         <i> <?php echo $value['fullname']?> (Admin)</i>
                        </span>
                        </div>
                      </div>
                    <?php } ?>
