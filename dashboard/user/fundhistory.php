                    ...
                    <div class="card card-plain">
                      <div class="card-body">
                        ...
                        <div class="alert alert-info alert-success">
                          <span>
                            Transaction ID : <?php echo $info['transaction_id'] ?> | <?php echo Farm::farmByID($info['farm_id'])[0]['name'] ?> | Amount Funded: ₦<?php echo $info['total_amount'] ?> | Funded Date :<?php echo $info['transaction_time'] ?>| Transaction status : <?php echo $info['status']?> 
                          </span>
                        </div>
                        <?php }?>
                      </div>
