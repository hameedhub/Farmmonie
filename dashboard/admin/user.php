...
if ($_POST) {
    # code...
    DB::query('UPDATE `users` SET `fullname`=:fullname,`phone`=:phone,`address`=:address,`bank_name`=:bank_name,`bank_account`=:bank_account WHERE id = :id', array(':fullname'=>$_POST['fullname'],':phone'=>$_POST['phone'], ':address'=>$_POST['address'], ':bank_name'=>$_POST['bank_name'], ':bank_account'=>$_POST['bank_account'], ':id'=>$_SESSION['user']));
