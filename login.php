...
if ($_POST) {
    # code...
    $value = DB::query('SELECT id, email, password, status, role FROM users WHERE email =:email AND password =:password', array(':email'=>$_POST['email'], ':password'=>md5($_POST['password'])));
    ...
    if (count($value) > 0) {   
        ...
        $msg = '<br><div class="alert alert-danger"><center> Sorry! Wrong <b>Email or Password </b> try again! </center></div>';
    }
}
...
<nav class="mobile-nav" style="background-color: #106b31;" > 
			...
			<l1><a href="login.php">Log In</a></l1>
			<l1><a href="register.php" class="signup-btn">Sign Up</a></l1>
			</ul>
	</div>  
</nav>
<!-- mobile menu End -->
...
<nav class="top-nav  alt-nav navwhite">
		<div class="container">
			...
			<li class="menu-list"><a href="login.php" class="menu-link">Log In</a></li>
			<li class="menu-list"><a href="register.php" class="menu-link signup-btn">Sign Up</a></li>
			</ul>
	</div>
</nav>
	<!-- Nav End -->	
		...
		<section class="intro-text _margin-100">
			<div class="container">
				<div class="profileuser"> 
					<h1 class="_margin-50 _middle boldtext">User Login</h1>
					<p class="_margin-20 _margin-b-20 _middle"></p>
					<div align="center">
						<div align="left" class="mainactionbutton">
														<form action="login.php" method="post" >
								<label class="form-label leftlabel"><b>Email Address</b></label>
								...
								<div class="form-group form-grouplast">
									<button type="submit" class="btn btn-block btn-large btn-success blue wide" id="login"><i class="fa fa-lock"></i>Login</button>
								</div> 
							</form>
						</div>    
						<div class="_margin-20">
							<a href="register.php" class="_margin-20">Create an Account Instead</a> <br>
